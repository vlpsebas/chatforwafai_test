...
function buildProjectWorkerOptions(project) {
  ...
  runnerWorker.modules = [
    ...
    {
      type: "ESModule",
      path: path4.join(modulesRoot, "node:console"),
      contents: fs3.readFileSync(
        path4.join(DIST_PATH, `worker/node/console.mjs`)
      )
    },
    {
      type: "ESModule",
      path: path4.join(modulesRoot, "node:vm"),
      contents: fs3.readFileSync(path4.join(DIST_PATH, `worker/node/vm.mjs`))
    }
  ];
